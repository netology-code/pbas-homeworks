...
1. Представьте, что вы являетесь инженером по автоматизации на промышленном предприятии. Для нужд АСУТ ТП вам необходимо срочно выбрать сетевое оборудование – коммутатор для подключения ПЛК в производственном цеху в количестве 6 шт. 
2. У поставщика в наличии 2 варианта коммутаторов: [Вариант 1](https://drive.google.com/file/d/1bUGOtyp-XKOjHK7C_hFUIK9T411NoVbA/view?usp=sharing) и [Вариант 2](https://drive.google.com/file/d/1hkbOE3cuJGR60fjM2ZNGFxDSmHj25chR/view?usp=sharing).
...
2. Сможете ли вы реализовать систему «Умный дом» или вам придется докупить кое-что самостоятельно для реализации системы? Если придется докупить, напишите список недостающих элементов. 
